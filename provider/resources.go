...
import (
	...
	gandi "github.com/go-gandi/terraform-provider-gandi/v2/gandi"

	"github.com/pczora/pulumi-gandi/provider/pkg/version"
)
...
const (
	...
	mainPkg = "gandi"
	// modules:
	mainMod = "index" // the gandi module
)
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		//
		//    - In provider/cmd/pulumi-tfgen-gandi/main.go, replace the
		...
		//
		//    - In provider/cmd/pulumi-resource-gandi/main.go, replace the
		...
		//
		//      	tfbridge.Main(context.Background(), "gandi", gandi.Provider(),
		...
		// convention is to have a function at "github.com/iwahbe/terraform-provider-gandi/provider".New
		...
		Keywords:   []string{"pczora", "gandi", "category/cloud"},
		License:    "Apache-2.0",
		Homepage:   "https://www.pulumi.com",
		Repository: "https://github.com/pczora/pulumi-gandi",
		...
		Golang: &tfbridge.GolangInfo{
			ImportBasePath: path.Join(
				"github.com/pczora/pulumi-gandi/sdk/",
	...
	prov.MustComputeTokens(tokens.SingleModule("gandi_", mainMod,
