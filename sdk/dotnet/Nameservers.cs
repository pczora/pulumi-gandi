...
{
    [Obsolete(@"gandi.index/nameservers.Nameservers has been deprecated in favor of gandi.domains/nameservers.Nameservers")]
    [GandiResourceType("gandi:index/nameservers:Nameservers")]
    public partial class Nameservers : global::Pulumi.CustomResource
    {
        ...
        public Nameservers(string name, NameserversArgs args, CustomResourceOptions? options = null)
            : base("gandi:index/nameservers:Nameservers", name, args ?? new NameserversArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Nameservers(string name, Input<string> id, NameserversState? state = null, CustomResourceOptions? options = null)
            : base("gandi:index/nameservers:Nameservers", name, state, MakeResourceOptions(options, id))
        {
        }
