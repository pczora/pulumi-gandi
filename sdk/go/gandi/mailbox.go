...
func NewMailbox(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gandi:index/mailbox:Mailbox", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMailbox(ctx *pulumi.Context,
	...
	var resource Mailbox
	err := ctx.ReadResource("gandi:index/mailbox:Mailbox", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
