...
/**
 * @deprecated gandi.index/mailbox.Mailbox has been deprecated in favor of gandi.email/mailbox.Mailbox
 */
export class Mailbox extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MailboxState, opts?: pulumi.CustomResourceOptions): Mailbox {
        pulumi.log.warn("Mailbox is deprecated: gandi.index/mailbox.Mailbox has been deprecated in favor of gandi.email/mailbox.Mailbox")
        return new Mailbox(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gandi:index/mailbox:Mailbox';
