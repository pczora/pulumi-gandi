...
warnings.warn("""gandi.index/dnsseckey.DnssecKey has been deprecated in favor of gandi.domains/dnsseckey.DNSSecKey""", DeprecationWarning)
...
class DnssecKey(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(DnssecKey, __self__).__init__(
            'gandi:index/dnssecKey:DnssecKey',
            resource_name,
            __props__,
            opts)
