...
class DomainAdminArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[str] city: City for the contact
        :param pulumi.Input[str] country: The two letter country code for the contact
        :param pulumi.Input[str] email: Contact email address
        :param pulumi.Input[str] family_name: Family name of the contact
        :param pulumi.Input[str] given_name: Given name of the contact
        :param pulumi.Input[str] phone: Phone number for the contact
        :param pulumi.Input[str] street_addr: Street Address of the contact
        :param pulumi.Input[str] type: One of 'person', 'company', 'association', 'public body', or 'reseller'
        :param pulumi.Input[str] zip: Postal Code/Zipcode of the contact
        :param pulumi.Input[bool] data_obfuscated: Whether or not to obfuscate contact data in WHOIS
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] extra_parameters: Extra parameters, needed for some jurisdictions
        :param pulumi.Input[bool] mail_obfuscated: Whether or not to obfuscate contact email in WHOIS
        :param pulumi.Input[str] organisation: The legal name of the organisation. Required for types other than person
        :param pulumi.Input[str] state: The state code for the contact
        """
