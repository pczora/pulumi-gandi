...
class DomainAdmin(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param str city: City for the contact
        :param str country: The two letter country code for the contact
        :param str email: Contact email address
        :param str family_name: Family name of the contact
        :param str given_name: Given name of the contact
        :param str phone: Phone number for the contact
        :param str street_addr: Street Address of the contact
        :param str type: One of 'person', 'company', 'association', 'public body', or 'reseller'
        :param str zip: Postal Code/Zipcode of the contact
        :param bool data_obfuscated: Whether or not to obfuscate contact data in WHOIS
        :param Mapping[str, str] extra_parameters: Extra parameters, needed for some jurisdictions
        :param bool mail_obfuscated: Whether or not to obfuscate contact email in WHOIS
        :param str organisation: The legal name of the organisation. Required for types other than person
        :param str state: The state code for the contact
        """
