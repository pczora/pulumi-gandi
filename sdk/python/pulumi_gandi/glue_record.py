...
class _GlueRecordState:
    def __init__(__self__, *,
                 ...
                 fqdn_unicode: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] fqdn_unicode: The fqdn unicode of the record
    ...
    def fqdn_unicode(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    @fqdn_unicode.setter
    def fqdn_unicode(self, value: Optional[pulumi.Input[str]]):
...
warnings.warn("""gandi.index/gluerecord.GlueRecord has been deprecated in favor of gandi.domains/gluerecord.GlueRecord""", DeprecationWarning)
...
class GlueRecord(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 zone: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        pulumi.log.warn("""GlueRecord is deprecated: gandi.index/gluerecord.GlueRecord has been deprecated in favor of gandi.domains/gluerecord.GlueRecord""")
        ...
        super(GlueRecord, __self__).__init__(
            'gandi:index/glueRecord:GlueRecord',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter(name="fqdnUnicode")
    def fqdn_unicode(self) -> pulumi.Output[str]:
        """
        The fqdn unicode of the record
        """
        return pulumi.get(self, "fqdn_unicode")
